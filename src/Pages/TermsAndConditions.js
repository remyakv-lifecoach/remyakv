...
export default function TermsAndConditions() {
    return (
        <main>
            ...
            <HeaderText title="Terms & Conditions"/>
            <section className="sample-text-area">
                <div className="container box_1170">
                    <h3 className="text-heading">Welcome to www.remyakv.com!</h3>
                    <p className="sample-text">

                        <p>These terms and conditions outline the rules and regulations for the use of Remya K V's Website,
                            located at www.remyakv.com.</p>

                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                            www.remyakv.com if you do not agree to take all of the terms and conditions stated on this page.</p>
                        ...
                        <p>We employ the use of cookies. By accessing www.remyakv.com, you agreed to use cookies in agreement
                            with the Remya K V's Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, Remya K V and/or its licensors own the intellectual property rights for all
                            material on www.remyakv.com. All intellectual property rights are reserved. You may access this from
                            www.remyakv.com for your own personal use subjected to restrictions set in these terms and
                            conditions.</p>

                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from www.remyakv.com</li>
                            <li>Sell, rent or sub-license material from www.remyakv.com</li>
                            <li>Reproduce, duplicate or copy material from www.remyakv.com</li>
                            <li>Redistribute content from www.remyakv.com</li>
                        </ul>

                        <p>This Agreement shall begin on the date hereof.</p>

                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                            certain areas of the website. Remya K V does not filter, edit, publish or review Comments prior to
                            their presence on the website. Comments do not reflect the views and opinions of Remya K V,its
                            agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                            and opinions. To the extent permitted by applicable laws, Remya K V shall not be liable for the
                        ...
                        <p>Remya K V reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant Remya K V a non-exclusive license to use, reproduce, edit and authorize others to
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                            ...
                            the absence of Remya K V; and (d) the link is in the context of general resource information.</p>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                            website, you must inform us by sending an e-mail to Remya K V. Please include your name, your
                        ...
                        <p>No use of Remya K V's logo or other artwork will be allowed for linking absent a trademark license
                            agreement.</p>
                        ...
                        <p>Please read our
                            <a href="privacy-policy" className="genric-btn link circle">Privacy Policy</a>
                        </p>
